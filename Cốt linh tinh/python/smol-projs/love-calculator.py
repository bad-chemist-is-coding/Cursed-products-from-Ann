...
while True:
    ...
    '''Cách tính điểm: Xét số chữ cái trong TRUE (hàng chục của điểm) LOVE 
    (hàng đơn vị của điểm) xuất hiện trong tên của bạn và người ấy'''
    ...
    var = input('Bạn có muốn xem bói lại? (Y/N)\n')
    if var.lower().startswith('n'):
        print('Chúc may mắn! Khi nào đổi người yêu/crush thì quay lại tính nhá!')
        break