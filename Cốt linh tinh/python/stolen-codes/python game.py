...
#
# Created by Hà Tường Nguyên on 02/09/2023
#
    ...
    while True:
        ...
        try:
            ...
            while i_TimeGuess <= c_i_MAX_GUESS:
                ...
                # Take the guess from the player and prevent the wrong datatype
                ...
                # Check the guess then show the clue to the player
                ...
                # If the player ran out of guess
...
# Create a function for checking the guess from the player
def f_GetClue(secret_num, user_guess):
    # Make a blank list to contain the clue
    clue = []

    # If the guess from the player is correct
...
if __name__ == '__main__':
    ...
    # Make sure that the "Project1_BagelsGame.py" file is located in the same folder as the file that needs to be imported
    """
